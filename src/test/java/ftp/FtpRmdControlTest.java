...
import ftp.controls.FtpRmdControl;

public class FtpRmdControlTest extends FtpTest {

	public FtpRmdControlTest() throws Exception {
		super();
	}

	@Before
	public void setUp() throws Exception {
		this.control = new FtpRmdControl(store);
	}
